...
public class SettingUniversalPreference extends PreferenceActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		utils.iniFragment(universalFragment,this);
	}
	
	public static class UniversalFragment extends PreferenceFragment{
		@Override
		public void onCreate(Bundle savedInstanceState) {
			// TODO Auto-generated method stub
			super.onCreate(savedInstanceState);
			addPreferencesFromResource(R.xml.universal_preference);
		}
	}
